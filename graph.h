...
/*********************************************************************************************************/
/*                   CLASS GRAPH  -- Determines the graph, its members and functions                     */
/*********************************************************************************************************/   
...
class graph{
    ...
    public:
        ...
        void generate_random_positions(const int &NumNodes, const int &SizeX, const int &SizeY); //Function that places individuals in random positions on an X by Y grid;
...
void graph:: generate_random_positions(const int &NumNodes, const int &SizeX, const int &SizeY){
    random_device rd;
    mt19937 gen(rd());
    uniform_int_distribution<int>distX(0,SizeX-1);
    uniform_int_distribution<int>distY(0,SizeY-1);
